...
export default function Information({navigation}) {
  ...
  return (
    ...
    style={{backgroundColor: "white"}}>
      ...
      <View style={{display:'flex',flexDirection:'row',justifyContent:'space-between',alignItems:'center',height:75}}>
      <TouchableOpacity onPress={handleGoBack}>
        ...
        <TouchableOpacity onPress={handleSave}>
        <Text style={{ fontSize: 15, color: "#4B61DD",marginRight:16 }}>Save</Text>
        </TouchableOpacity>
      </View>
      <View > 
        <FloatingLabelInput
